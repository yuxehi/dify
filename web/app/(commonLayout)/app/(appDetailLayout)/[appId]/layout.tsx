...
const AppDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  const {isCurrentWorkspaceEditor, isLoadingCurrentWorkspace, isCurrentWorkspaceOwner} = useAppContext()
  ...
  const getNavigations = useCallback((appId: string, isCurrentWorkspaceEditor: boolean, mode: string) => {
    const navs = [
      ...
      ...(isCurrentWorkspaceOwner && isCurrentWorkspaceEditor
          ? [{
            name: mode !== 'workflow'
  ...
  return (
    <div className={cn(s.app, 'flex relative', 'overflow-hidden')}>
      {appDetail && (
        <AppSideBar title={appDetail.name} icon={appDetail.icon} icon_background={appDetail.icon_background as string}
                    desc={appDetail.mode} navigation={navigation}/>
      )}
